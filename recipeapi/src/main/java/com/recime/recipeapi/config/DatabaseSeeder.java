...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    private final RecipesIngredientsRepository recipiesIngredientsRepository;
    private final InstructionRepository instructionRepository;

    public DatabaseSeeder(IngredientRepository ingredientRepository, RecipeRepository recipeRepository,
            RecipesIngredientsRepository recipiesIngredientsRepository, InstructionRepository instructionRepository) {
        this.ingredientRepository = ingredientRepository;
        this.recipeRepository = recipeRepository;
        this.recipiesIngredientsRepository = recipiesIngredientsRepository;
    ...
    private void seedCacioPepeRecipe() {
        ...
        List<RecipesIngredients> recipeIngredients = createCacioPepeRecipeIngredients(cacioPepeIngredients,
                cacioPepeRecipe);
        recipiesIngredientsRepository.saveAll(recipeIngredients);
    ...
    private List<RecipesIngredients> createCacioPepeRecipeIngredients(List<Ingredient> ingredients, Recipe recipe) {
        return List.of(
                new RecipesIngredients(
                        new RecipesIngredientsId(Long.valueOf(1), Long.valueOf(1)), "g", 100.0, ingredients.get(0),
                        recipe),
                new RecipesIngredients(
                        new RecipesIngredientsId(Long.valueOf(2), Long.valueOf(1)), "g", 120.0, ingredients.get(1),
                        recipe),
                new RecipesIngredients(
                        new RecipesIngredientsId(Long.valueOf(3), Long.valueOf(1)), "g", 8.0, ingredients.get(2),
                        recipe));
    }
    ...
    private List<Instruction> createCacioPepeInstructions(Recipe recipe) {
        return List.of(
                ...
                new Instruction(null, 3, "Add the pecorino and black pepper to a bowl with pasta water.",
                        recipe),
                new Instruction(null, 4,
                        "Mix the pecorino and black pepper with the pasta in a pan with low heat.", recipe));
    }
    ...
    private List<RecipesIngredients> createCarbonaraRecipeIngredients(
            List<Ingredient> existingIngredients,
            List<Ingredient> newIngredients,
            Recipe recipe) {
        return List.of(
                new RecipesIngredients(
                        new RecipesIngredientsId(Long.valueOf(1), Long.valueOf(2)), "g", 100.0,
                        existingIngredients.get(1), recipe),
                new RecipesIngredients(
                        new RecipesIngredientsId(Long.valueOf(2), Long.valueOf(2)), "g", 120.0,
                        existingIngredients.get(2), recipe),
                new RecipesIngredients(
                        new RecipesIngredientsId(Long.valueOf(3), Long.valueOf(2)), "g", 8.0,
                        existingIngredients.get(0), recipe),
                new RecipesIngredients(
                        new RecipesIngredientsId(Long.valueOf(4), Long.valueOf(2)), null, 4.0, newIngredients.get(0),
                        recipe),
                new RecipesIngredients(
                        new RecipesIngredientsId(Long.valueOf(5), Long.valueOf(2)), null, 1.0, newIngredients.get(1),
                        recipe),
                new RecipesIngredients(
                        new RecipesIngredientsId(Long.valueOf(6), Long.valueOf(2)), "g", 150.0, newIngredients.get(2),
                        recipe));
    }
    ...
    private List<Instruction> createCarbonaraInstructions(Recipe recipe) {
        return List.of(
                ...
                new Instruction(null, 3,
                        ...
                        recipe),
                new Instruction(null, 4, "Add the mixture to a pan with the pasta and guanciale.", recipe),
